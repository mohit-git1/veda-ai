...
export default function Sidebar() {
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <aside className="hidden md:flex flex-col w-[240px] min-h-screen bg-white border-r border-[#F0F0F0] fixed left-0 top-0 z-30">
        {/* Logo */}
        ...
        <div className="px-[16px] mb-6">
          <button
            ...
            className="w-full h-[40px] flex items-center justify-center gap-2 rounded-full text-white text-[14px] font-medium transition-all"
            style={{ 
              background: '#111111', 
              border: '2px solid #E8431C',
              boxShadow: '0 0 8px rgba(232, 67, 28, 0.2)' 
            }}
          >
        ...
        <div className="px-[12px] pb-[20px] mt-auto">
          {/* Settings Link */}
          <Link href="/settings" className="flex items-center gap-3 px-[12px] h-[40px] rounded-[10px] text-[14px] text-[#6B7280] hover:bg-[#F9FAFB] hover:text-[#111111] transition-colors mb-4">
          ...
          <div className="flex items-center gap-[12px] p-[12px] bg-[#F9FAFB] rounded-[12px]">
            <div className="w-[36px] h-[36px] rounded-full bg-[#E8431C] flex items-center justify-center overflow-hidden flex-shrink-0">
              <span className="text-[14px] font-semibold text-white">D</span>
            </div>
            <div className="min-w-0">
              <p className="text-[13px] font-semibold text-[#111111] truncate line-clamp-1">Delhi Public School</p>
              <p className="text-[12px] text-[#6B7280] truncate line-clamp-1">Bokaro Steel City</p>
            </div>
          </div>
        </div>
      </aside>
